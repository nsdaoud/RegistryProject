...
Public Class FrmDocuments
    ...
    Private Sub btnscan_Click(sender As Object, e As EventArgs) Handles btnscan.Click
        ...
        'Dim frm As New DotNet_TWAIN_Demo.DotNetTWAINDemo
        'frm.idScannedDocuments = grddocuments.SelectedRows(0).Cells("id_Document").Value
        'frm.id_Register = id_Register
        'frm.SeqNumber = SeqNumber

        'frm.DocumentSeq = grddocuments.SelectedRows(0).Cells("SeqDocument").Value
        'frm.Registry_Year = Registry_Year
        'frm.registryType = registryType
        'frm.TypeOfRegisty = TypeOfRegisty
        'frm.FilePath = DBProvider.filepathString
        'frm.Show()

        Dim frmscan As New Frmscanfile
        frmscan.Show()
