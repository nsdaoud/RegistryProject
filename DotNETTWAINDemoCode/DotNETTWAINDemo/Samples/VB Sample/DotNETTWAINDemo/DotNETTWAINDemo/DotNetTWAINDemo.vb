...
Partial Public Class DotNetTWAINDemo
    ...
    Public Sub New()
        ...
        m_StrProductKey = "t0078tgAAAATPqQydrbGqiMzS0w5o626Z5v1bXR/fJ+bOOh2sScilCJ3hvUIjOfpAoGdBKpdQX3VNNkCVdzjx3YGcAd+iXA8WkElp4wItKyTg"
    ...
    Private Sub InitUI()
        ...
        thOCR.Visible = False
        thReadBarcode.Visible = False
        thAddBarcode.Visible = False
