...
#End Region
    ...
    Private Sub grdregistry_CellFormatting(sender As Object, e As UI.CellFormattingEventArgs) Handles grdregistry.CellFormatting
    ...
    Private Sub btnexporttoexcel_Click(sender As Object, e As EventArgs) Handles btnexporttoexcel.Click
        Try
            Dim pdfExporter As New ExportToExcelML(grdregistry)
            ...
            Try
                pdfExporter.RunExport("D:\r.xlsx")
                RadMessageBox.SetThemeName(Me.grdregistry.ThemeName)
